...
COSC 1436 57002
Repl.it
This program will promt the user to input a number and then output multiple different operations with the number. Each loop will be couned and the total will be displayed at the end, after the user enters -1.
*/
...
When 0 was entered the program ran but the operator that divides the number by itself outputed "-nan"

When j was entered the program broke
